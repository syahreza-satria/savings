    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
            ...
            <form action="{{ route('register') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label for="name" class="block mb-2 text-gray-700">Nama Lengkap:</label>
                ...
                <div class="mb-6">
                    <label for="password_confirmation" class="block mb-2 text-gray-700">Konfirmasi Password:</label>
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword('password_confirmation')"
                            ...
                            <svg id="eye-slash-icon-password_confirmation" class="hidden w-5 h-5" fill="none"
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <p class="text-sm text-center text-gray-500">Sudah memiliki akun? <a href="{{ route('login') }}"
                            class="text-blue-500 transition duration-300 hover:text-blue-300">Masuk Di Sini!</a></p>
                </div>
            </form>
        </div>
    </div>
